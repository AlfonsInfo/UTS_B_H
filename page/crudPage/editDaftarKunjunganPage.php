...
0.19);">
    ...
    <div style="display:flex; justify-content:flex-end; width:100%; padding:0;">
        ...
        <button type="button" class="btn btn-outline-danger"><a href="../../process/deleteDaftarKunjuganProcess.php?id='.$_SESSION['kunjungan']['id'].'" onClick="return confirm ( \'Are you sure want to delete this data?\')">Delete Data</a></button>
