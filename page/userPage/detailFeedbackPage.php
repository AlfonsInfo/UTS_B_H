...
<div class="section-header body d-flex justify-content-between">
  ...
  <div class="form-group">
    ...
    <textarea name="saran" id="saran" cols="60" rows="3" disabled  ><?php echo $data['masukan']?></textarea>
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Masukan</label><br>
    <textarea name="masukan" id="masukan" cols="60" rows="10" disabled ><?php echo $data['saran']?></textarea>
  </div>
